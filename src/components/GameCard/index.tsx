...
function GameCard({link, text}:{link:string, text:string}) {
    ...
    return (
        <div>
            ...
            <video height="auto" width="500" autoPlay muted loop style={{margin: "25px 100px 25px 100px", opacity: hover ? 0.2 : 1}} onMouseEnter={()=> {setHover(true)}} onMouseLeave={()=> {setHover(false)}}>
